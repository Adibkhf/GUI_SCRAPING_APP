...
S = get_data('https://www.ansa.it/sito/notizie/cronaca/2022/02/27/bracciante-morto-di-freddo-a-barletta-una-targa-lo-ricorda_6101a7b0-0224-4e0e-8c17-1574c99f2095.html')
...
def ecrire_article(tab_l):
    ...
    for x in tab_l:
        ...
        doc.add_page_break()
    doc.save('C:/Users/HP/Desktop/KBscan/RDP/RDP API/ANSA italie/demo.docx')
